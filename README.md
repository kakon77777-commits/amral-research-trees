...
| [`bsd-period-calibration/`](./bsd-period-calibration/) | Rank-2 BSD cross-curve calibration: a level-19 partner, the relative regulator modulo `(11,t^121)`, and Farey-cup normalization removing four eigensymbol unit scales | Research proofs, reproducible summands and handoff ZIP; global class comparison remains open |
