...
| [`bsd/`](./bsd/) | Birch and Swinnerton-Dyer conjecture — 26 packages across 4 sub-lines (Phase0 global-enclosure framework, Phase1 Banwait–Huang reproduction, Phase2 non-semistable family, P5 single-prime strong BSD; 1 package recovered from a nested zip, see `bsd/README.md`) | [amral.evemisslab.com/bsd/](https://amral.evemisslab.com/bsd/) (Phase0 only; Phase1/Phase2/P5 not yet curated) |
