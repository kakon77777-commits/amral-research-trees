...
VALIDATOR = ROOT / "src" / "pnp_glc_i0" / "semantic_validator_v024.py"
ARTIFACTS = ROOT / "artifacts-v0.2.4"
FIXTURES = ROOT / "fixtures-v0.2.4"
TRACES = ARTIFACTS / "traces"
AUTH = ARTIFACTS / "auth"
PROJECTION_SPEC = ARTIFACTS / "candidate-projection-spec.v0.2.4.json"
CLOSURE_SPEC = ARTIFACTS / "artifact-closure-spec.v0.2.4.json"
ROLE_SPEC = ARTIFACTS / "evidence-role-spec.v0.2.4.json"
PUBLIC_KEY = ARTIFACTS / "trace-public-key.v0.2.4.json"
SANDBOX = ARTIFACTS / "capability-sandbox.v0.2.4.json"
RUN_STANDARD = ARTIFACTS / "run-standard.v0.2.4.json"
RUN_ROBUST = ARTIFACTS / "run-robust.v0.2.4.json"
MAXIMAL = ARTIFACTS / "maximal-run.v0.2.4.json"
FAIRNESS = ARTIFACTS / "fairness.v0.2.4.json"
INVARIANT = ARTIFACTS / "parity-invariant.v0.2.4.json"
PARITY_CONTRACT = ARTIFACTS / "contract-parity.v0.2.4.json"
TWO_SAT_CONTRACT = ARTIFACTS / "contract-2sat.v0.2.4.json"
...
def version_candidate(
    ...
    record["provenance"]["sources"][0].update(
        {
            "id": "run-record-v0.2.4-candidate",
            "locator": "schemas/run-record.schema.v0.2.4-candidate.json",
    ...
    for claim in record["claims"]:
        claim["source_refs"] = ["run-record-v0.2.4-candidate"]
...
def main() -> None:
    ...
    write_json(
        ...
        {
            "schema": "schemas/run-record.schema.v0.2.4-candidate.json",
            "validator": "src/pnp_glc_i0/semantic_validator_v024.py",
