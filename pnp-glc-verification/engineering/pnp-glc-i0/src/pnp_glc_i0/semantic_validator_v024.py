"""Versioned external semantic validator for run-record schema v0.2.4.
...
VALIDATOR_VERSION = "0.2.4"
GATE_VERSION = "i0-admission-gate/0.2.4"
PROJECTION_SPEC_ID = "urn:evemisslab:pnp-glc:candidate-projection:0.2.4"
ARTIFACT_CLOSURE_SPEC_ID = "urn:evemisslab:pnp-glc:artifact-closure:0.2.4"
EVIDENCE_ROLE_SPEC_ID = "urn:evemisslab:pnp-glc:evidence-roles:0.2.4"
TRACE_PRODUCER = "pnp-glc-i0-capability-sandbox"
TRACE_SIGNER_ID = "i0-test-trace-signer-20260809"
TRACE_MEASUREMENT_MODEL = "authenticated-i0-single-worker-linear/0.2.4"
TRACE_SIGNATURE_CONTEXT = b"pnp-glc-i0-trace-v0.2.4\0"
PASS = "pass"
FAIL = "fail"
UNKNOWN = "unknown"
...
PINNED_SCHEMA_HASH = "16ebcc7de4196d0c46fc9c309f2060f856e321c0012c5b775390c04234f9dcc8"
PINNED_PROJECTION_SPEC_HASH = "ccf57716e63ad6b627f48688925054975254a88344e7f84ecbec9cf0145b9d6d"
PINNED_CLOSURE_SPEC_HASH = "579b6f7da8be3712fe6130ad900cf0cba189496100548cbf87655687a7690588"
PINNED_ROLE_SPEC_HASH = "4efc4c71c6275227b14429e58fcecc4e949459918315d27cc476765c7d24d850"
PINNED_TRACE_PUBLIC_KEY_HASH = "e1fa8b78e470f2606c2d529c4bba6725a75cd3fa575888f9e5ad46548bd05b4a"
PINNED_SANDBOX_HASH = "e1ba3ab7f54ead37611bf3da448c8d23e751bdddb6c0254ed7814430a94aef02"
PINNED_RUN_STANDARD_HASH = "8913dc28caa176f2c1c8cc234a5ba68761d0e49585db94f458a4073ce5fe70b2"
PINNED_RUN_ROBUST_HASH = "7bb53ee6ce84907e84e7f5a9075851a4acea4829a25f40b797be684a0b8d493d"
PINNED_MAXIMAL_HASH = "072251192baf7530da7098901246f22ce273bbbe10801e8b9f05d4302500ae29"
PINNED_FAIRNESS_HASH = "b366928f090a7a0894a48d68e3cb1f2c33a1aefa1ff66a270e82293ac4aa89cd"
PINNED_PARITY_INVARIANT_HASH = "a73db946a4d44912bb878d3efb9af1730bd93de63ffa5b1b7e8f1fdcad311064"
PINNED_PARITY_CONTRACT_HASH = "178332bdb50f176d4265c2703995dd26a2381985512b57d75c89fd21b1adf8af"
PINNED_TWO_SAT_CONTRACT_HASH = "2221e275b462d9c4f6bdff80e4610db8bfcb319745171a1c5973b9c12e117d34"
...
def _parse_json_int(token: str) -> int:
    if token == "-0":
        raise ValueError("negative zero is outside the v0.2.4 canonical domain")
    return int(token)
    ...
    if isinstance(value, float):
        issues.append(
                ValidationIssue(
                    ...
                    path,
                    "candidate projection v0.2.4 admits integers only",
                )
        )
        return issues
    ...
    if not expected:
        return UNKNOWN, (
            ValidationIssue(
                ...
                "$.mechanism.id",
                "no pinned v0.2.4 operational role map exists for this family/mechanism",
            ),
        )
    ...
    if projection is not None and (
        ...
        issues.append(
            ValidationIssue(
                ...
                "projection spec id/version does not match v0.2.4",
            )
        )
    if closure_spec is not None and (
        ...
        issues.append(
            ValidationIssue(
                ...
                "closure spec id/version does not match v0.2.4",
            )
        )
    expected_edges = {
    ...
    if any(actual_value != expected_value for actual_value, expected_value in declaration_checks):
        issues.append(
            ValidationIssue(
                ...
                "$.problem",
                "candidate declarations do not match the pinned v0.2.4 family interface",
            )
        )
    ...
    if not isinstance(trace_envelope, dict) or (
        ...
        issues.append(
            ValidationIssue(
                ...
                "trace is not a v0.2.4 capability-trace envelope",
            )
        )
