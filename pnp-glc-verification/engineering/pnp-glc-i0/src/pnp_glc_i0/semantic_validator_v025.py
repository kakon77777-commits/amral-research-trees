"""Versioned external semantic validator for run-record schema v0.2.5.
...
VALIDATOR_VERSION = "0.2.5"
GATE_VERSION = "i0-admission-gate/0.2.5"
PROJECTION_SPEC_ID = "urn:evemisslab:pnp-glc:candidate-projection:0.2.5"
ARTIFACT_CLOSURE_SPEC_ID = "urn:evemisslab:pnp-glc:artifact-closure:0.2.5"
EVIDENCE_ROLE_SPEC_ID = "urn:evemisslab:pnp-glc:evidence-roles:0.2.5"
TRACE_PRODUCER = "pnp-glc-i0-capability-sandbox"
TRACE_SIGNER_ID = "i0-test-trace-signer-20260809"
TRACE_MEASUREMENT_MODEL = "authenticated-i0-single-worker-linear/0.2.5"
TRACE_SIGNATURE_CONTEXT = b"pnp-glc-i0-trace-v0.2.5\0"
PASS = "pass"
FAIL = "fail"
UNKNOWN = "unknown"
...
PINNED_SCHEMA_HASH = "8a799a869cf6cdd17d1191a9d859ab25899ff9e651b454725814e4b458b92596"
PINNED_PROJECTION_SPEC_HASH = "42348657bd0475442b266385d0c88e8685f21334d78a49ecb0cf64d2d3977e18"
PINNED_CLOSURE_SPEC_HASH = "dfc5a11cf6296f4d83b054b7f4f903e509b0982f9c61d231d423e7f78b5ff71d"
PINNED_ROLE_SPEC_HASH = "6b49d3907209d5edeed839fe698a25ea96451cdcf7534f2383125e9f3f98c088"
PINNED_TRACE_PUBLIC_KEY_HASH = "ac0724dff856910dba024c75810bae1a34573d65353843d98d27015a392e2757"
PINNED_SANDBOX_HASH = "c4d79688d00fe868c90f74171d4e3fab4fdb27e5d4d0e750e1b9707f4018fce6"
PINNED_RUN_STANDARD_HASH = "c6a725ba5e0c73b24b9cb648aac30ec5f262f862d525e7f9a499280d232a392b"
PINNED_RUN_ROBUST_HASH = "1209dce408047f7cd45b99957d8d39f4bdf9fa5eb2fe897fa8758d122ae6ac04"
PINNED_MAXIMAL_HASH = "72d1f09ff809fd2a6daf240d8eb8dae2e823fc357dc84570e054ab9d6094c879"
PINNED_FAIRNESS_HASH = "b006f5c52dadfe0b5d563caa4138b3d6ea0f415c7b3d3bc62eb72758b6f14099"
PINNED_PARITY_INVARIANT_HASH = "774308583ed5843539fda7b9f106f11def29191f72cf033299f6a0c5b292aa1c"
PINNED_PARITY_CONTRACT_HASH = "e1eb8ff0a2bd8b7e7cc9e1a8d02e1450ee5464a7763019503e1457ba75837351"
PINNED_TWO_SAT_CONTRACT_HASH = "78f96b2e8fd7c207c8eada2853382a93354b685ea0e8fe89215512c76a009d71"
...
def _parse_json_int(token: str) -> int:
    if token == "-0":
        raise ValueError("negative zero is outside the v0.2.5 canonical domain")
    return int(token)
    ...
    if isinstance(value, float):
        issues.append(
                ValidationIssue(
                    ...
                    path,
                    "candidate projection v0.2.5 admits integers only",
                )
        )
        return issues
    ...
    if not expected:
        return UNKNOWN, (
            ValidationIssue(
                ...
                "$.mechanism.id",
                "no pinned v0.2.5 operational role map exists for this family/mechanism",
            ),
        )
    ...
    if projection is not None and (
        ...
        issues.append(
            ValidationIssue(
                ...
                "projection spec id/version does not match v0.2.5",
            )
        )
    if closure_spec is not None and (
        ...
        issues.append(
            ValidationIssue(
                ...
                "closure spec id/version does not match v0.2.5",
            )
        )
    expected_edges = {
    ...
    if any(actual_value != expected_value for actual_value, expected_value in declaration_checks):
        issues.append(
            ValidationIssue(
                ...
                "$.problem",
                "candidate declarations do not match the pinned v0.2.5 family interface",
            )
        )
    ...
    if not isinstance(trace_envelope, dict) or (
        ...
        issues.append(
            ValidationIssue(
                ...
                "trace is not a v0.2.5 capability-trace envelope",
            )
        )
