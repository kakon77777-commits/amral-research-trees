"""Reproducible bounded I0 v0.2.2 candidate experiment runner."""
...
from .semantic_validator_v022 import (
    ArtifactIndex,
    _artifact_closure,
...
def run_i0(
    ...
    schema = project_root / "schemas" / "run-record.schema.v0.2.2-candidate.json"
    fixtures = project_root / "fixtures-v0.2.2"
    ...
    report.update(
        {
            "experiment_id": "I0-v0.2.2-candidate-20260809",
    ...
    report["nonclaims"].extend(
        [
            "v0.2.2 candidate has not been independently accepted or promoted",
