"""Versioned external semantic validator for run-record schema v0.2.2.
...
GATE_VERSION = "i0-admission-gate/0.2.2"
PROJECTION_SPEC_ID = "urn:evemisslab:pnp-glc:candidate-projection:0.2.2"
ARTIFACT_CLOSURE_SPEC_ID = "urn:evemisslab:pnp-glc:artifact-closure:0.2.2"
EVIDENCE_ROLE_SPEC_ID = "urn:evemisslab:pnp-glc:evidence-roles:0.2.2"
TRACE_PRODUCER = "pnp-glc-i0-capability-sandbox"
TRACE_SIGNER_ID = "i0-test-trace-signer-20260809"
TRACE_MEASUREMENT_MODEL = "authenticated-i0-single-worker-linear/0.2.2"
TRACE_SIGNATURE_CONTEXT = b"pnp-glc-i0-trace-v0.2.2\0"
PASS = "pass"
FAIL = "fail"
UNKNOWN = "unknown"
...
PINNED_SCHEMA_HASH = "bdbb386ce7eaab5377344bf29762ccbe45ea6371ac72742de509467cb70bb556"
PINNED_PROJECTION_SPEC_HASH = "7860aa7a741fae5dcc6846b614c16450d29d17573563d6373a243931b9b51e57"
PINNED_CLOSURE_SPEC_HASH = "11f6cb511adfcf9528d11390e59ce1b52d8f709053ff5aa7295230f5b3e604eb"
PINNED_ROLE_SPEC_HASH = "2fefa7aacb9b6d914c3b78cdb2c187262d12a35bd56b14fd5882a71b84991a3f"
PINNED_TRACE_PUBLIC_KEY_HASH = "0536bc7b976fc2770a90d52e011eb4c1cdc51e476cb8b4a572fbed699bc4536c"
PINNED_SANDBOX_HASH = "79776e16c722822af13603750a7618460c5bbb3473c4ebd016025d8b45632a28"
PINNED_RUN_STANDARD_HASH = "93d78838b22c3a722ddacc6d3ff8356e0a8f1e7492d52ede5434487b99ef4454"
PINNED_RUN_ROBUST_HASH = "b5397734bf1d4797bde377381d61aaf095f5ab22b70b100fc531b045dbbee741"
PINNED_MAXIMAL_HASH = "06bcab9a77fc3d1e5907ccbecdbcb717e6366b972ff5ae2c0857269be7a8c718"
PINNED_FAIRNESS_HASH = "7612253b900dea356a70a6a4f45e5a57d879aa4861a1b292df7105a3bc562e5f"
PINNED_PARITY_INVARIANT_HASH = "3fabffd25262ef86bbfabf3a34b8b0dad5e75b4677e1c3ff635feff544f49016"
PINNED_PARITY_CONTRACT_HASH = "b5bf37414f310fb376ec4c0a12407893a01d5377d19be0d9dbf25b13b38d078b"
PINNED_TWO_SAT_CONTRACT_HASH = "d481630507a57b8d90b3601c53ae81c8f9a1c70c296af12909459c52edb7f993"
...
def _parse_json_int(token: str) -> int:
    if token == "-0":
        raise ValueError("negative zero is outside the v0.2.2 canonical domain")
    return int(token)
    ...
    if isinstance(value, float):
        issues.append(
                ValidationIssue(
                    ...
                    path,
                    "candidate projection v0.2.2 admits integers only",
                )
        )
        return issues
...
def _artifact_closure(
    ...
    while queue:
        ...
        if not isinstance(envelope, dict):
            status = FAIL
            continue
        envelope_spec_id = envelope.get("spec_id")
        if not isinstance(envelope_spec_id, str) or not envelope_spec_id:
            status = FAIL
        ...
        if (
            ...
            or version != VALIDATOR_VERSION
            or not isinstance(edges, list)
            or artifact_type not in EDGE_RELATIONS
        ):
            status = FAIL
            artifact_types[reference] = "invalid-envelope"
            continue
        ...
        for edge in edges:
            ...
            if (
                ...
                or relation.get(role) != child_type
            ):
                status = FAIL
                continue
            edge_roles.add(role)
    ...
    if not expected:
        return UNKNOWN, (
            ValidationIssue(
                ...
                "$.mechanism.id",
                "no pinned v0.2.2 operational role map exists for this family/mechanism",
            ),
        )
    ...
    if projection is not None and (
        ...
        issues.append(
            ValidationIssue(
                ...
                "projection spec id/version does not match v0.2.2",
            )
        )
    if closure_spec is not None and (
        ...
        issues.append(
            ValidationIssue(
                ...
                "closure spec id/version does not match v0.2.2",
            )
        )
    expected_edges = {
    ...
    if any(actual_value != expected_value for actual_value, expected_value in declaration_checks):
        issues.append(
            ValidationIssue(
                ...
                "$.problem",
                "candidate declarations do not match the pinned v0.2.2 family interface",
            )
        )
    ...
    if not isinstance(trace_envelope, dict) or (
        ...
        issues.append(
            ValidationIssue(
                ...
                "trace is not a v0.2.2 capability-trace envelope",
            )
        )
