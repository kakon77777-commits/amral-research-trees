...
## 5. Bandwidth-One Ceiling 重建

新增 `notes/04_Reconstructing_68_185_Ceiling.md` 與 `scripts/ceiling_law256_constants.py`。

Anthropic Lean repo 的 $N=256$ exact-rational adversarial law 給出 $p_0=0.681828687463832\ldots$，約 $68.18286875\%$。目前 external LP certificate `cert_N256_blk_b128m.json` 未包含於公開 repo，因此 exact configuration weights 尚不能完全重跑。
