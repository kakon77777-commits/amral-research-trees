...
## 6. v3 — Small-N primal toy LP / Boundary-Spike probe

新增：

- `notes/05_SmallN_Toy_LP_and_Boundary_Spike.md`
- `scripts/smallN_pair_ceiling_toy.py`
- `results/smallN_open_band_summary.csv`
- `results/smallN_edge_cap_curve.csv`
- `results/smallN_support_extension.csv`
- `results/toy_optimal_law_N4_M24.csv`
- `results/official_LawN256_boundary_row.json`
- `figures/smallN_edge_cap_curve.png`

本輪首次自行重現 open-band adversarial-law 機制，並提出 `Boundary-Spike Obstruction (BSO)`。
