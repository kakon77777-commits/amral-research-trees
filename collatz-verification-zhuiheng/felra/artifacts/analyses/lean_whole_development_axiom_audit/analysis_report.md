# FELRA Analysis Report — Every theorem in collatz-lean, and what each one rests on

- Analysis ID: `lean_whole_development_axiom_audit`
- Type: `formal_check`
...
```json
{
  ...
  "obligation": {
    "path": "D:\\Ai\\work together\\lean\\collatz\\Collatz\\Audit.lean",
    "sha256": "786d9c40de27b6ac65b3a40e5a62c2328f161a8973126e071a9f8a78d7f3c5ff",
    "bytes": 18820
  },
  "exit_code": 0,
  ...
  "assumptions": [
    "Audit.lean covers every theorem in the development; that is enforced by the development's own gate/audit_axioms.py, not by FELRA"
  ],
  "limitations": [
    "the audit covers the theorems this file prints axioms for; a theorem the file never mentions is outside it",
    "Lean checks the statements as written; the float64 horizon measured above is a fact about arithmetic, not one of its theorems",
...
- `analyses\lean_whole_development_axiom_audit\analysis_report.md`
- `analyses\lean_whole_development_axiom_audit\metrics.json`
